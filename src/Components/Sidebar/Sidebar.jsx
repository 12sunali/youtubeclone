...
import sunali from '../../assets/sunali.jpg';
...
const Sidebar = ({ sidebar, category, setCategory, darkMode }) => {
  return (
    <div className={`sidebar ${darkMode ? "dark" : "light"} ${sidebar ? "" : "small-sidebar"}`}>
      ...
      <div className="subscribed-list">
        <h3>Subscribed</h3>
        <div className="side-link"><img src={sunali} alt="" /><p>PewDiePie</p></div>
